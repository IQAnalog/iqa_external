...
#ifndef __F1000_EP_CORE_B_REGS__
#define __F1000_EP_CORE_B_REGS__

#ifndef __CHIP_ID__
#define __CHIP_ID__
#define CHIP_ID(x) (x)->chip_id_register.chip_id_u.chip_id
#define f1000_ep_core_b_regs_CHIP_ID(x) (x)->chip_id_register.chip_id_u.bits.chip_id
...
#define f1000_ep_core_b_regs_CORE_ID(x) (x)->configuration_register.configuration_u.bits.core_id
#define f1000_ep_core_b_regs_FETCH_ENABLE(x) (x)->configuration_register.configuration_u.bits.fetch_enable
...
#define f1000_ep_core_b_regs_DUMMY_BITS(x) (x)->dummy_bits_register.dummy_bits_u.bits.dummy_bits
...
#define f1000_ep_core_b_regs_ENABLE_LMFC_COUNT(x) (x)->lmfc_irq_control_register.lmfc_irq_control_u.bits.enable_lmfc_count
#define f1000_ep_core_b_regs_LMFC_IRQ_COMPARE(x) (x)->lmfc_irq_control_register.lmfc_irq_control_u.bits.lmfc_irq_compare
...
#define f1000_ep_core_b_regs_LMFC_COUNTER(x) (x)->lmfc_counter_register.lmfc_counter_u.bits.lmfc_counter
...
#define f1000_ep_core_b_regs_LMFC_IRQ_ACK(x) (x)->lmfc_irq_ack_register.lmfc_irq_ack_u.bits.lmfc_irq_ack
...
typedef struct f1000_ep_core_b_regs_s
{
...
} f1000_ep_core_b_regs_t;

#endif /* __F1000_EP_CORE_B_REGS__ */
